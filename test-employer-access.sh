...
# Test script for Employer access
...
echo "Testing TPA-level access (should fail)..."
aws s3 ls s3://kyndly-ichra-documents/submissions/test-tpa-123/ || echo "Access denied as expected"
