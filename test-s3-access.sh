...
# Simple test script to debug S3 access
...
# Test S3 operation with more debug
echo "Testing S3 command with credentials..."
export AWS_ACCESS_KEY_ID=$access_key
export AWS_SECRET_ACCESS_KEY=$secret_key
export AWS_SESSION_TOKEN=$session_token

echo "Testing basic S3 list command..."
aws s3 ls s3://kyndly-ichra-documents/submissions/ --debug
